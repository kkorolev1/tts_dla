...
class VarianceAdaptor(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.pitch_embedding = nn.Embedding(kwargs["num_bins"], kwargs["encoder_dim"])
        ...
        self.energy_embedding = nn.Embedding(kwargs["num_bins"], kwargs["encoder_dim"])
    ...
    def energy(self, len_reg_output, energy_target=None, gamma=1.0):
        ...
        if energy_target is not None:
            ...
            estimated_energy = torch.exp(energy_pred) - 1 # (energy_target + 1) - 1
